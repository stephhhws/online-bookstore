...
import { FormService } from 'src/app/services/shop-form.service'
...
export class CheckoutComponent implements OnInit {
  ...
  // update the cart total quantity & price at checkout form
  reviewCartDetails() {
  ...
  copyShippingAddressToBillingAddress(event) {
    ...
    if (event.target.checked) {
      // copy the shipping address details to billing address
    ...
    if (!this.checkoutFormGroup.invalid && this.displayError.textContent === "") {
      ...
      this.checkoutService.createPaymentIntent(this.paymentInfo).subscribe(
        (paymentIntentResponse) => {
          // confirm card payment stripe.com
  ...
  resetCart() {
    ...
    // update storage with latest state of the cart 
  ...
  getStates(formGroupName: string) {
    ...
    // pass in either shipping/ billing address
