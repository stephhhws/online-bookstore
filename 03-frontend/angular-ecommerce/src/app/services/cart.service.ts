...
export class CartService {
  ...
  // change the totalPrice & totalQuanity to BehaviorSubject, this can store the latest event and send to new subscribers
  ...
  // cartItem: the key, // this.cartItems: the value
  persistCartItems() {
    ...
    // helper function to computer the total
    computeCartTotals() {
